...
export default async function PokemonList() {
  // LÍNEA PARA FORZAR EL ERROR Y PROBAR EL ERROR HANDLER 
  //throw new Error("Error simulado para el laboratorio de la Pokédex.");

  // El siguiente código no se ejecutará mientras la línea de arriba esté activa
